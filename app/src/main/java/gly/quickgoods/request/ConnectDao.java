package gly.quickgoods.request;

import java.io.IOException;
import java.util.List;

import gly.quickgoods.application.MyApplication;
import gly.quickgoods.constants.HttpConstants;
import gly.quickgoods.utils.Logger;
import gly.quickgoods.utils.okhttp.CommonOkHttpClient;
import gly.quickgoods.utils.okhttp.cookie.PersistentCookieStore;
import gly.quickgoods.utils.okhttp.listener.DisposeDataHandle;
import gly.quickgoods.utils.okhttp.listener.DisposeDataListener;
import gly.quickgoods.utils.okhttp.request.CommonRequest;
import gly.quickgoods.utils.okhttp.request.RequestParams;
import okhttp3.Call;
