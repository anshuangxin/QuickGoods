...
import gly.quickgoods.fragment.DianDanFragment;
import gly.quickgoods.fragment.DingDanHeYanFragment;
import gly.quickgoods.fragment.DingDanLiuFragment;
import gly.quickgoods.fragment.ShouKuanFragment;
import gly.quickgoods.fragment.TiaoMaFragment;
import gly.quickgoods.fragment.WeiXinFragment;
import gly.quickgoods.fragment.XianjinFragment;
import gly.quickgoods.fragment.ZhiFuBaoFragment;
import gly.quickgoods.request.ConnectDao;
import gly.quickgoods.utils.AnimFragmentUtil;
...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initView();
        ConnectDao.getGoods("1111111111111", new DisposeDataListener() {
            @Override
            public void onSuccess(Object responseObj) {
                Logger.log("responseObjgetGoods: " + responseObj.toString());
            }

            @Override
            public void onFailure(Object reasonObj) {
                Logger.log("reasonObj: " + reasonObj.toString());
            }
        });
    }
