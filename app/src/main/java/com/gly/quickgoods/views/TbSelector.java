...
import com.gly.quickgoods.utils.ScreenUtil;
...
public class TbSelector extends HorizontalScrollView {
    ...
    private void initGroup() {
        ...
        for (int i = 0; i < len; i++) {
            ...
            RadioGroup.LayoutParams l = new RadioGroup.LayoutParams(
                    (int) (ScreenUtil.getScreenDisplay((Activity) getContext())[0]
                                                / titleList.size()*1.2f), (int) (density * 35),
                    Gravity.CENTER);
            l.weight = 1;
