package com.bjyzqs.kuaihuo_yunshouyin.constants;
...
public class HttpConstants {
     ...
     * 挂单
     */
    public static final String GUA_DAN = ROOT_URL + "/admin.php/android/android/Guadan";
    /**
     * 提交试用
     */
    public static final String SEND_MAIL = ROOT_URL + "/themes/web/mail.php";
    /**
     * 订单流
     */
    public static final String ORDER_LIST = ROOT_URL + "/admin.php/android/android/orderlist";
}
